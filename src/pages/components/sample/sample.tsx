    ...
    <>
      <div className={styles.bg}>
        <header className={styles.header}>
          <a href="../home/home" className={styles.backBtn}>
        ...
        <main>
          <div className={styles.character}>
            ...
            >
              <SwiperSlide><Image src={img1} alt='友人' className={styles.characters} /></SwiperSlide>
              <SwiperSlide><Image src={img2} alt='友人2' className={styles.characters} /></SwiperSlide>
              <SwiperSlide><Image src={img3} alt='友人3' className={styles.characters} /></SwiperSlide>
            </Swiper>
          </div>
          <ul>
            ...
            <li className={`${styles.clickBox} ${isActive1 ? styles.clickBox2 : ''}`} onClick={handleClick1}>{/*ここを押したときに*/}
              ...
              <div>{/*divの中が消える*/}
                ...
                <div className={styles.lunchBreak}>
                  <p>お昼休み</p>
                </div>
                <div className={styles.afterSchool}>
                  <p>放課後</p>
                </div>
